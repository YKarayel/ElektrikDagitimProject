...
namespace ElektrikDagıtım.Dal.Migrations
{
    ...
    [Migration("20231105082357_tokenAndAdminSettings")]
    partial class tokenAndAdminSettings
    {
            ...
            modelBuilder.Entity("Entities.Concrete.Sistem.ABONE", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AboneId = 1,
                            AbnKayıtTarihi = new DateTime(2023, 11, 5, 11, 23, 56, 693, DateTimeKind.Local).AddTicks(9894),
                            AdSoyad = "admin",
                            Durum = true,
