...
namespace ElektrikDagıtım.Dal.Migrations
{
    ...
    [Migration("20231109144956_faturaChanges3")]
    partial class faturaChanges3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElektrikDagıtım.Entities.Concrete.Sistem.ABONE", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            GsmNo = "05419999999",
                            KayıtTarih = new DateTime(2023, 11, 9, 17, 49, 56, 168, DateTimeKind.Local).AddTicks(9233),
                            Sifre = "ꉟ뺾昊ﰺꄄ헻",
                            TC = "12345678910",
                            YetkiId = 1
                        });
            ...
            modelBuilder.Entity("ElektrikDagıtım.Entities.Concrete.Muhasebe.FATURA", b =>
                {
                    b.HasOne("ElektrikDagıtım.Entities.Concrete.Muhasebe.TAHSILAT", null)
                        .WithMany("FaturaId")
