...
namespace ElektrikDagıtım.Dal.Migrations
{
    ...
    [Migration("20231105082857_butceModelDegisikleri")]
    partial class butceModelDegisikleri
    {
            ...
            modelBuilder.Entity("Entities.Concrete.Sistem.ABONE", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AboneId = 1,
                            AbnKayıtTarihi = new DateTime(2023, 11, 5, 11, 28, 57, 29, DateTimeKind.Local).AddTicks(7795),
                            AdSoyad = "admin",
                            Durum = true,
