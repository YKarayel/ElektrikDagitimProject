...
namespace ElektrikDagıtım.Dal.Migrations
{
    ...
    [Migration("20231106063812_BaseEntity_Changed_And_Other_Entities_Changed")]
    partial class BaseEntity_Changed_And_Other_Entities_Changed
    {
            ...
            modelBuilder.Entity("Entities.Concrete.Sistem.ABONE", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            GsmNo = "05419999999",
                            KayıtTarih = new DateTime(2023, 11, 6, 9, 38, 12, 112, DateTimeKind.Local).AddTicks(188),
                            Sifre = "ꉟ뺾昊ﰺꄄ헻",
                            TC = "12345678910",
                            YetkiId = 1
                        });
